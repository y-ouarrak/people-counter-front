<template>
	<div>
        ...
        <div class="card">
                  ...
                  <div class="card-body">
                    <div class="color-box">
                      <button class="btn btn-square digits btn-primary">#7366ff</button>
                      <button class="btn btn-square digits btn-secondary">#f73164</button>
                      <button class="btn btn-square digits btn-success">#51bb25</button>
                      <button class="btn btn-square digits btn-info">#a927f9</button>
                      <button class="btn btn-square digits btn-warning">#f8d62b</button>
                      <button class="btn btn-square digits btn-danger">#dc3545</button>
                      <button class="btn btn-square digits btn-light">#f4f4f4</button>
