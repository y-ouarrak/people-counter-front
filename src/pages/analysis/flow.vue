    ...
    <div class="card">
      <div class="card-body">
        ...
        <div class="row">
          ...
          <div class="col-12 mb-2"><b-button variant="primary" @click="showChart">Inquire</b-button></div>
        </div>
        <div id="chart">
...
<script>
  export default {
    data() {
      ...
      //     'places':7,
      //     'user':'Digieye',
      //     'createdAt': '2021-10-10T16:53:30.000Z',
      //     'updatedAt': '2021-10-10T16:53:30.000Z',
      //   }
      // ],
      // fields: [
      //   { key: 'areaId', label:'#' },
